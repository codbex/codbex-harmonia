...
The menu component is a listing structure with optional headers to create menus. It can be used as a dropdown and a context menu.
...
<button x-h-button x-h-menu-trigger.dropdown>
  Dropdown
...
<ClientOnly>
<component-container data-html="/components/menu/menu.html" data-class="!p-0 border-dashed">
</component-container>
</ClientOnly>

```html
<div x-h-menu-trigger class="flex justify-center items-center p-12">
