...
<form class="flex flex-col gap-3">
  <div x-h-field data-orientation="horizontal">
    <input x-h-radio type="radio" name="size" id="r_small" value="small" checked />
    <label x-h-label for="r_small">Small</label>
  </div>
  <div x-h-field data-orientation="horizontal">
    <input x-h-radio type="radio" name="size" id="r_medium" value="medium" />
    <label x-h-label for="r_medium">Medium</label>
  </div>
  <div x-h-field data-orientation="horizontal">
    <input x-h-radio type="radio" name="size" id="r_large" value="large" />
